...
function solution(survey, choices) {
    ...
    answer += setAnswer("RT", R, T);
    answer += setAnswer("CF", C, F);
    answer += setAnswer("JM", J, M);
    answer += setAnswer("AN", A, N);
